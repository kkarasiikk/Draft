const CACHE_NAME = 'life-budget-v32';
...
const NETWORK_FIRST = ['./unsaved-guard.js', './ai-chat.js', './ai-chat.css', './', './index.html', './app.js', './categories-default.js'];
const FILES_TO_CACHE = ['../unsaved-guard.js', '../ai-chat.js', '../ai-chat.css', './', './index.html', './app.js', './firebase-config.js', '../categories-default.js', './manifest.json',

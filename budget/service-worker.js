const CACHE_NAME = 'life-budget-v49';
...
const NETWORK_FIRST = ['./side-nav.js', './side-nav.css', './recurring.js', './recurrence.js', './scroll-lock.js', './unsaved-guard.js', './ai-chat.js', './ai-chat.css', './', './index.html', './app.js', './categories-default.js'];
const FILES_TO_CACHE = ['../side-nav.js', '../side-nav.css', './recurring.js', '../tasks/recurrence.js', '../scroll-lock.js', '../unsaved-guard.js', '../ai-chat.js', '../ai-chat.css', './', './index.html', './app.js', './firebase-config.js', '../categories-default.js', './manifest.json',

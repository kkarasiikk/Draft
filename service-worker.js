...
// обслуговує лише хаб.
const CACHE_NAME = 'life-home-v46';
...
const NETWORK_FIRST = ['./side-nav.js', './side-nav.css', './home-summary.js', './streak.js', './stats.js', './scroll-lock.js', './', './index.html', './home.js', './export-data.js'];
const FILES_TO_CACHE = ['./side-nav.js', './side-nav.css', './home-summary.js', './goals/streak.js', './tasks/stats.js', './scroll-lock.js', './', './index.html', './home.js', './export-data.js',

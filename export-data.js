  ...
  function tasksSheets(d, L) {
    ...
    return [
      { key: 'tasks', name: L.sheetTasks, rows: (d.tasks || []).slice().sort(function (a, b) {
        ...
        // застосунку більше немає, тож у нових завданнях ці стовпці порожні.
        // Але в старих там лежать дані, і вивантаження — єдине місце, де їх
        // ще можна побачити: прибрати стовпці означало б тихо їх втратити.

...
const CACHE_NAME = 'life-goals-v58';
...
const NETWORK_FIRST = ['./side-nav.js', './side-nav.css', './scroll-lock.js', './unsaved-guard.js', './ai-chat.js', './ai-chat.css', './', './index.html', './app.js', './streak.js', './review.js', './categories-default.js'];
const FILES_TO_CACHE = ['../side-nav.js', '../side-nav.css', '../scroll-lock.js', '../unsaved-guard.js', '../ai-chat.js', '../ai-chat.css', './', './index.html', './app.js', './streak.js', './review.js', '../categories-default.js', './manifest.json',

...
const CACHE_NAME = 'life-workout-v13';
...
const NETWORK_FIRST = ['./ai-chat.js', './ai-chat.css', './', './index.html', './app.js'];
const FILES_TO_CACHE = ['../ai-chat.js', '../ai-chat.css', './', './index.html', './app.js', './manifest.json',

...
- **Повторювані завдання** — щодня / кожні N днів, щотижня (з вибором днів:
  ...
  «щосуботи» на «кожні 7 днів після того, як реально зробив».
...
- «Завдання» — один спільний список без вкладених списків/проєктів;
  drag-and-drop немає, сортування автоматичне. Повторення не розпізнається
  з рядка швидкого додавання — його задають у формі.

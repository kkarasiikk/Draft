...
- Над календарем — картка **«Зараз»**: одна наступна дія (кнопка «Далі»
...
- Головний екран — **календар місяця** з завданнями прямо в клітинках
  (до 3 на день, далі «+N»); тап на день відкриває **екран дня** зі списком,
  тап на заголовок місяця перемикає на **річну сітку** з кількістю завдань
  по місяцях.
...
- `tasks/now-queue.test.js` — порядок черги «Зараз» і підсумок дня;
